...
export default function Reservation({ email }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/reg-book-table", formData);
        ...
        <div className="form reservation-form bg-black-10">
            ...
            <div className="input-wrapper">
              ...
              <div className="icon-wrapper" style={{ position: "relative" }}>
                <FaCalendarAlt
                  ...
                  onClick={() =>
                    document
                      .querySelector('input[name="reservationDate"]')
                      .focus()
                  }
          ...
          >
            ...
            <address className="body-4">
              No. 15, Colombo Road, Colombo 00300,
              <br />
              Sri Lanka
            </address>
          </div>
